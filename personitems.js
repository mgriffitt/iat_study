define(['questAPI'], function(Quest){
	...
	**/
	API.addPagesSet('basicPage',{
		...
		// Q4 TODO change to gender identity, keep dropd, and move down
	    {
	        inherit: 'dropd',
	        name: 'eyecolor',
		...
		// TODO: Q2 birthmonth, keep as-is, and move down
	    {
	        inherit: 'dropd',
	        name: 'birthyear',
		...
		// TODO: Q1 birthyear, move to top and keep as-is
	    {
	        inherit: 'dropd',
	        name: 'birthmonth',
		...
		// Q3 TODO add race and make selectMulti
		...
		// Q5 TODO add zipcurrent and make text
		// {},

		// Q6 TODO add ziplongest and make text
		// {},
